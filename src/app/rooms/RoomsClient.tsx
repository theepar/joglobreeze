  ...
  const rooms = [
    {
      ...
      description: "Experience communal living in our comfortable shared house with modern amenities and a welcoming atmosphere. Perfect for budget travelers and those looking to meet new people.",
      details: "Shared accommodation | Common areas | Budget-friendly | Garden view",
      type: "shared"
    },
    {
      id: 2,
      ...
      description: "Enjoy complete privacy and comfort in our full house rental. Perfect for families, groups, or couples seeking a private retreat with all the amenities of home.",
