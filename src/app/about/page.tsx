  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 sm:mt-12 md:mt-20">
        {/* About Section */}
        <section id="about" className="mb-16 sm:mb-20" data-animate="true">
        ...
        <section id="history" className="mb-16 sm:mb-20" data-animate="true">
        ...
        {/* Facilities Section */}
        <section id="facilities" className="mb-16 sm:mb-20" data-animate="true">
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center transition-all duration-1000 ease-out ${
        ...
        {/* Location Section */}
        <section id="location" className="mb-16 sm:mb-20 text-center" data-animate="true">
